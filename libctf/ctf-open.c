...
ctf_bufopen (const ctf_sect_t *ctfsect, const ctf_sect_t *symsect,
	     ...
	     ctf_error_t *errp)
{
  return ctf_bufopen_len (ctfsect, symsect, strsect, NULL, parent, 0, errp);
}
...
ctf_buflen (const ctf_sect_t *ctfsect, ctf_error_t *errp)
{
  ...
  ctf_bufopen_len (ctfsect, NULL, NULL, &len, NULL, 0, errp);
  return len;
}

/* Internal workings of ctf_bufopen, ctf_buflen, and ctf_create.
...
ctf_bufopen_len (const ctf_sect_t *ctfsect, const ctf_sect_t *symsect,
		 ...
		 ctf_import_flags_t import_flags, ctf_error_t *errp)
{
		     ...
		     ctf_import_flags_t flags)
{
  ...
  if (pfp->ctf_dmodel != fp->ctf_dmodel)
    return ctf_err (err_locus (fp), EINVAL,
		    _("data model %s of parent differs from model %s of child"),
		    pfp->ctf_dmodel->ctd_name, fp->ctf_dmodel->ctd_name);
