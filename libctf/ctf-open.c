		 ...
		 ctf_error_t *errp)
{
  ...
  /* Set the data model from the archive (if recorded: V1 archives only), or
     failing that from the symtab.  v2 may need to adjust this post facto: if
     we opened from an archive, we force-set the model of the child to that of
     the parent.  */
